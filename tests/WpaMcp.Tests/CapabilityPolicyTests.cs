...
public sealed class CapabilityPolicyTests
{
    ...
    public void Projection_FiltersCallableSurfaceButRetainsClosedCatalogEvidence()
    {
        ...
        Assert.Equal(63, full.Tools.Count);
        Assert.Equal(63, catalog.AllTools.Count);
        Assert.Equal(60, catalog.Tools.Count);
        Assert.Equal(60, projection.ServerTools.Count);
        ...
        Assert.Equal(63, toolCatalog.Tools.Count);
        ...
        Assert.Equal(63, discovery.ToolResourceIndex().TotalItems);
    }
